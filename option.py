...
parser.add_argument('--model', default='elsface',
                    help='model name')
#The name of the model is same as filenames of .py in ./model

"""
qyw
"""
parser.add_argument('--n_feats', type=int, default=60,
...
parser.add_argument('--depths', type=list, default=[1])
#parser.add_argument('--depths', type=list, default=[2])
parser.add_argument('--window_size', type=int, default=8)
parser.add_argument('--mlp_ratio', type=int, default=2)
parser.add_argument('--qkv_bias', type=bool, default=True)
parser.add_argument('--qk_scale', default=None)
